            ...
            <div className="relative w-full">
                <div className='container mx-auto px-4 py-20'>
                    ...
                    <div className="md:mb-16 font-serif tracking-tight text-xl text-black md:text-3xl">
                        ...
                        <ul className='md:w-1/2 grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 font-sans text-black/80 text-lg tracking-tighter text-justify font-light mt-4 p-2 gap-y-2 border-collapse border'>
                            <li className='hover:underline flex items-center cursor-default text-start'>TV</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>Wifi access</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>Room Services</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>Local Cuisine</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>24 hour Front Desk</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>Tour Assistance</li>
                            <li className='hover:underline flex items-center cursor-default text-start'>Laundary Services</li>
                        </ul>
                    </div>
